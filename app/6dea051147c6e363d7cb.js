...
var esm = __webpack_require__("tEiQ");
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return react_router_dom_BrowserRouter; });
...
/* unused concated harmony import __RouterContext */
...
function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return react_default.a.createElement(react_router_context.Consumer, null, function (context) {
      ...
      var location = typeof to === "string" ? Object(esm_history["c" /* createLocation */])(to, null, null, context.location) : to;
